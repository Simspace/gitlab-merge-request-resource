...
// GetConfidential returns CreateNoteInput.Confidential, and is useful for accessing the field via an interface.
func (v *CreateNoteInput) GetConfidential() bool { return v.Confidential }
