...
This resource uses genqlient for handling GraphQL APIs. All API calls should be
autogenerated from variables. The Gitlab API schema is included here to aid in
autogeneration but may need to be updated from time to time. See the
[genqlient docs](https://github.com/Khan/genqlient/blob/main/docs/INTRODUCTION.md) for more details.
